(function() {
  ...
  module.exports = function(grunt) {
    var cfjs, coffee2Js, delFile, destCss, destFonts, destImg, destJs, dirs, ref, ref1, ref2, ref3, scss2css, scss2cssmin, srcCss, srcCssmin, srcFonts, srcImg, srcJs, srcJsCompress, srcScss;
    dirs = {
      destDir: 'dest',
      srcDir: 'src'
    };
    ...
    ref3 = [dirs.srcDir + '/cfjs', dirs.srcDir + '/coffee2Js'], cfjs = ref3[0], coffee2Js = ref3[1];
    grunt.config.init({
